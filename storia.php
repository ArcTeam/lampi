        ...
        <div class="containner">
          <nav class="navbar navbar-light">
            <ul class="nav nav-pills">
              <li class="nav-item"><a class="nav-link" href="#origini">le origini</a></li>
              <li class="nav-item"><a class="nav-link" href="#oggi">l'associazione oggi</a></li>
            </ul>
          </nav>
        </div>
    </div>
