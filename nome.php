...
>>>>>>> 16abd846bf8cda6ea524ac4867a23e6c1805ec8d
    ...
    <div class="mainContent bg-white">
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col">
            ...
            <blockquote class="blockquote mb-5 text-justify">
              ...
              <div class="float-right clearfix ml-3 p-1 border border-secondary">
              ...
              <img style="" alt="" src="img/biografia_lampi/tomba.jpg" title="La tomba di Giovanni Battista Lampi nel Zentralfriedhof di Vienna, opera dello scultore Josef Klieber" align="right" hspace="5px" vspace="5px">
        ...
        <?php // NOTE: finire di impaginare la bibliografia ?>
        <div class="row mt-5">
          <div class="col">
            ...
            <ul>
              ...
              <li><span class="font-weight-bold"></span>, <span class="font-italic"></span>, <span></span></li>
            </ul>
          	<b>N. Rasmo</b>, <i>Giambattista Lampi pittore</i>, Trento 1957 (riedito nella “Collana Artisti Trentini”, IV, Trento 1977);<br>
          	<i>Un ritrattista nell’Europa delle corti. Giovanni Battista Lampi 1751-1830</i>, catalogo della mostra (Trento, Castello del Buonconsiglio), a cura di F. Mazzocca, R. Pancheri, A. Casagrande, Trento 2001;<br>
          	<b>R. Pancheri</b>, <i>Lampi, Giovanni Battista</i>, in <i>Dizionario Biografico degli Italiani</i>, vol. LXIII, 2004, <i>ad vocem</i>;<br>
          	<b>R. Pancheri</b>, <i>Giovanni Battista Lampi alla corte di Caterina II di Russia</i>, Trento 2011. <br><br>
          </div>
        </div>
      </div>
...
<?php // NOTE: creare funzione per scraping foto da wikimedia ?>
<!-- https://commons.wikimedia.org/w/api.php?action=query&list=search&srsearch=incategory:%22Johann-Baptist_Lampi_d._%C3%84.%22&srnamespace=6 -->
