      ...
      <div class="container">
        <div class="row">
          <div class="col">
            ...
            <p>Su associazionegblampi.it la vostra privacy è protetta e rispettata. I vostri dati personali, i commenti e le opere che ci invierete sono usati in modo confidenziale e sicuro, in concordanza con le vigenti leggi sulla privacy.<br>
            Scrivendo alle nostre email acconsentirete alla raccolta, al trattamento e all'archiviazione, da parte nostra, dei vostri dati secondo la Privacy Policy di associazionegblampi.it.<br>
            In caso di dubbi o timori riguardo ai vostri dati personali, al contenuto di questo sito web o ad altri argomenti relativi a associazionegblampi.it vi invitiamo a scriverci all'email qui indicata (associazione.lampi@gmail.com).</p>

            <h4>Dati Personali e opere coperte da diritto d'autore</h4>
            <p>I dati personali e le opere coperte da diritto d'autore vengono raccolti attraverso l'utilizzo di e-mail che ci invierete e di form online. Ogni volta che visiterete il nostro sito web raccoglieremo informazioni generiche sulla provenienza geografica dei visitatori, sui loro sistemi informatici, ma in maniera rigorosamente anonima. Tutti questi dati vengono incorporati in file o database di responsabilità dello staff di associazionegblampi.it.</p>
            ...
            <ul class="pl-3">
              ...
              <li>- informarvi circa i servizi proposti dalla nostra associazione</li>
              <li>- costituire un database a scopo di consultazione a cui ha accesso unicamente il personale dell'Associazione Culturale G.B.Lampi</li>
            </ul>
            ...
            <p>Nel tuo browser puoi impostare le preferenze di privacy in modo da non memorizzare cookies, cancellarli dopo ogni visita o ogni volta che chiudi il browser, o anche accettare solo i cookies di associazionegblampi.it e non quelli di terze parti; esiste anche un servizio, Your Online Choices, che ti mostra quali cookie installano i vari servizi e come puoi disattivarli, uno per uno.</p>

            <h4>Raccogliamo solo i dati personali essenziali</h4>
            <p>Non si richiede alcun dato oltre il minimo necessario. Tutti i dati sono trattati con modalità elettroniche e sono utilizzati dallo staff di associazionegblampi.it tramite operazioni meccaniche necessarie a espletare i servizi richiesti, compresa la modifica e la cancellazione dei dati da parte del proprietario.</p>

            <h4>Diritto di accesso, aggiornamento e cancellazione dei vostri dati personali e dei file inviati</h4>
            <p>Avete il diritto di ottenere da noi comunicazioni intellegibili e complete circa i vostri file e le vostre opere, i vostri dati personali e aziendali in nostro possesso e avete il diritto di modificarli, aggiornarli o cancellarli. Inoltre, potete far cessare l'utilizzo dei vostri dati da parte di associazionegblampi.it scrivendoci una e-mail.</p>
            <p>Gli utenti di associazionegblampi.it garantiscono che i dati personali forniti al sito sono veritieri, esatti, completi e aggiornati, e che provvederanno a comunicarci eventuali aggiornamenti.</p>

            <h4>Non trasferimento dei vostri dati e delle opere coperte da diritto d'autore</h4>
            <p>I dati e le opere coperte da diritto d'autore, che gli utenti ci invieranno via email e per posta normale, non vengono trasferiti ad alcuna persona esterna allo staff di associazionegblampi.it ed esterna alla cerchia dei relativi collaboratori se non dietro espressa autorizzazione dell'autore. Tutti i dati sono accessibili da parte dello staff di associazionegblampi.it per garantirne l'adeguata manutenzione e svolgere le operazioni eventualmente richieste dai legittimi proprietari dei dati registrati.</p>
            ...
            <h4>Pubblicità</h4>
            <p>associazionegblampi.it non utilizza né incorpora all'interno delle proprie pagine alcun tipo di pubblicità di terzi</p>

            <h4>Titolare del trattamento dei dati</h4>
            <p>Titolare del trattamento dei dati è <strong>Associazione culturale G.B.Lampi</strong> con sede in Piazza della Fontana, 2, 38010 Sanzeno (TN) Italia.<br>
            Per qualsiasi richiesta e/o per l'esercizio dei Vostri diritti di cui all'art. 7 del Dlgs 196/03 potete scrivere a associazione.lampi@gmail.com, oppure telefonare al numero +39.0463.510050 o inviare un fax al +39.0463.510050.
          </div>
        </div>
      </div>
